...
<div class='wrap'>
  ...
  <div class='c'></div>
    ...
    <a href="/" class="text-left"><i id="back" class="fa fa-home text-white "> </i></a><h3 style="text-align: center; margin-bottom: 10px; color: white; font-family: geneva; font-size: 30px;">SCRAMBLE SECTION</h1>
        <div class="text-center mb-5">
            <img class="logo" src="/images/company.png" alt="" srcset="">
        </div>
